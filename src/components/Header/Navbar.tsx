            ...
            <li key={link.href}>
              <Link
                ...
                className={`text-sm xl:text-base font-bold py-2 whitespace-nowrap transition-colors duration-200 
                  ${pathname === link.href ? "text-[#FFE135]" : "text-white"} 
        ...
        {isSignedIn ? (
            ...
            {dropDown && (
              <div className="bg-white absolute w-80 right-10 rounded-xl border border-[#FFE135] p-5 mt-1">
                <Link
                  ...
                  className="text-black font-medium text-lg flex px-2  gap-3 items-center hover:bg-[#FFF6C0] mb-2 cursor-pointer rounded-lg p-1"
                >
                  <span>
                    <svg
                      width="20"
                ...
                <div className=" border-b border-[#9194A9] mb-2"></div>
          ...
          <div className="flex items-center md:px-4 lg:px-1 lg:space-x-1">
            ...
            <Link href="/sell-car" className="hidden md:block">
              <button className="bg-yellow-400 hover:bg-yellow-300 text-black px-2 sm:px-3 ml-2 lg:ml-0 lg:px-4 py-1.5 sm:py-2 rounded-md text-xs sm:text-sm lg:text-base font-bold transition-colors duration-200 whitespace-nowrap">
